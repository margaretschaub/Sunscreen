...
def create_list_of_links(starting_url):
    links = []
    foodland_list = get_store_id(starting_url)

    for retailer_store_id in foodland_list:
        ...
        if ceiling == 1:
            links.append(f'https://shop.foodland.com/sm/pickup/rsid/{retailer_store_id}/results?q=sunscreen&page=1&skip=0')
        elif ceiling == 2:
            links.append(f'https://shop.foodland.com/sm/pickup/rsid/{retailer_store_id}/results?q=sunscreen&page=1&skip=0')
            links.append(f'https://shop.foodland.com/sm/pickup/rsid/{retailer_store_id}/results?q=sunscreen&page=2&skip=30')
        else:
            links.append(f'https://shop.foodland.com/sm/pickup/rsid/{retailer_store_id}/results?q=sunscreen&page=1&skip=0')
            links.append(f'https://shop.foodland.com/sm/pickup/rsid/{retailer_store_id}/results?q=sunscreen&page=2&skip=30')
            links.append(f'https://shop.foodland.com/sm/pickup/rsid/{retailer_store_id}/results?q=sunscreen&page=3&skip=60')
